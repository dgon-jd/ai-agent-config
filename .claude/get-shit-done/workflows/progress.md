...
```bash
INIT=$(node /home/dgon/.claude/get-shit-done/bin/gsd-tools.cjs init progress)
```
...
- `STATE=$(node /home/dgon/.claude/get-shit-done/bin/gsd-tools.cjs state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node /home/dgon/.claude/get-shit-done/bin/gsd-tools.cjs summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node /home/dgon/.claude/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
